...
namespace Articy.Noname.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Noname.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Noname.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy.Noname.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Noname.Features.DefaultBasicCharacterFeatureFeature();
