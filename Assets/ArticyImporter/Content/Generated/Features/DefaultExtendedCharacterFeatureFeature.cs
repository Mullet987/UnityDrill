...
namespace Articy.Noname.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Noname.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.Noname.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
            if ((mMotivation != null))
            {
        ...
        {
            Articy.Noname.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.Noname.Features.DefaultExtendedCharacterFeatureFeature();
